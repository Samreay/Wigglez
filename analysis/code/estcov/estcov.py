...
samples = np.random.multivariate_normal(mean, cov, 900000)
...
mask = (np.abs(e1) < 0.3) & (np.abs(e2) < 0.3) & (np.abs(e3) < 0.3) & (m1 > 0) & (m2 > 0) & (m3 > 0) & (np.abs(a1-1) < 0.4)& (np.abs(a2-1) < 0.4)& (np.abs(a3-1) < 0.4)
