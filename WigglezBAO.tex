...
\begin{figure*}[t]
	...
	\end{center}
	\caption{The unreconstructed WiggleZ correlation function, shown with the associated correlation covariance constructed from the WizCOLA mocks \citep{KazinKoda2014,KodaBlake2015}.}
	\label{fig:wizcola}
	%\end{wrapfigure}
\end{figure*}
